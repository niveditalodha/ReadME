...
| Use of version control tools| 3| Used Git and GitHub,https://github.com/niveditalodha/ReadME
|Use of  style checkers | 3 |Used Pylint Executed pylint command in CI/CD pipeline to output the warnings and errors.| 
| Use of code  formatters. | 3 | Used Pylint Executed pylint command in CI/CD pipeline to output the warnings and errors.|
| Use of syntax checkers. |  3 | Used Pylint Executed pylint command in CI/CD pipeline to output the warnings and errors.|
...
| test cases:.a large proportion of the issues related to handling failing cases.|2|https://github.com/niveditalodha/ReadME/issues|
| evidence that the whole team is using the same tools: everyone can get to all tools and files| 3|All the members of the team have set up environments setup locally. All used the same IDE, packages and tech stack to build the project.|
| evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)| 3| All members have tools necessary to run the project locally on their laptops.|
| evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)|3|Issues are assigned equally among all the members of the team
https://github.com/niveditalodha/ReadME/commits/main |
| evidence that the members of the team are working across multiple places in the code base|3| We assign issues in Github and start working on the required part of the project. The commit history of different members shows this. https://github.com/niveditalodha/ReadME/commits/main
|short release cycles | (hard to see in short projects) project members are committing often enough so that everyone can get your work|
| Online Sustainability evaluation |  |  | 
| Question 1.1: Does your website and documentation provide a clear, high-level overview of your software?| 3 |  README and Sphinx documentation clearly explain about the website and how the end user can use it.|
| Question 1.2: Does your website and documentation clearly describe the type of user who should use your software? | 3 | Yes, README and Sphinx documentation contains information about the target audience and how they can benefit from the application. |
| Question 1.3: Do you publish case studies to show how your software has been used by yourself and others? | 0 | No case studies yet |
...
| Question 10.4: Is there a branch of the repository that is always stable? (i.e. tests always pass, code always builds successfully) | 3 | Yes, the main branch is always stable |
